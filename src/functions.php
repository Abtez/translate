...
if ($_FILES['files']) {
    ...
    try {
        ...
        $messages['error'] = '<p class="p-4 text-red-500 text-sm font-semibold"> Something happened and could not get the text of your file, but since you do\'nt pay me, try something else  </p>';
    }
