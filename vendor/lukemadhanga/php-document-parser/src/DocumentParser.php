...
class DocumentParser {
     ...
     */
    public static $allowed_tags = '<h1><h2><h3><h4><h5><h6><p><i><strong><em><code><blockquote><a><img><ul><ol><li><table>';
    ...
    static function parseFromFile($filename, $mimetype = null) {
        if (!is_readable($filename)) {
            throw new \Exception("The file is unreadable, please convert it to another format & retry");
        }
        ...
        if (preg_match("/^text\/*/", $mimetype)) {
            ...
            throw new \Exception("The file type is not supported .$mimetype, please convert it to another format & retry");
        }
    }
